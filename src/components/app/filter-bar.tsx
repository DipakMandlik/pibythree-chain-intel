...
export function FilterBar({
  value, onChange, storeOptions, categoryOptions, skuOptions, regionOptions, showHorizon = true,
}: {
  value: FilterState;
  ...
  return (
    <div className="panel flex flex-wrap items-end gap-3 p-3">
      ...
      <Field label="Category" value={value.category} onChange={set("category")} options={categoryOptions} />
